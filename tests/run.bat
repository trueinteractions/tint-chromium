...
if exist ..\..\Tint\build\msvs\Release\tint.exe (
	set TINTEXEC=..\..\Tint\build\msvs\Release\tint.exe
) else if exist ..\..\Tint\build\msvs\Debug\tint.exe (
	set TINTEXEC=..\..\Tint\build\msvs\Debug\tint.exe
) else if exist ..\..\Tint\tint.exe (
	set TINTEXEC=..\..\Tint\tint.exe
