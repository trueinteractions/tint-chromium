module.exports = (function() {
  ...
  process.bridge.dotnet.import(path.join(execpath,'CefSharp.dll'));
  process.bridge.dotnet.import(path.join(execpath,'CefSharp.Core.dll'));
  process.bridge.dotnet.import(path.join(execpath,'CefSharp.Wpf.dll'));
  var util = require('Utilities');
  var Container = require('Container');
  var $ = process.bridge.dotnet;

  var settings = new $.CefSharp.CefSettings();
  settings.BrowserSubprocessPath = path.join(execpath,'CefSharp.BrowserSubprocess.exe');
